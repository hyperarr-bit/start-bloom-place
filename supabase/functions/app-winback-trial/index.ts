...
const assunto = (nome: string) =>
  nome ? `${nome}, o CORE agora é seu pra sempre por R$ 97,90` : "O CORE agora é seu pra sempre por R$ 97,90";
...
<div style="font-family:-apple-system,Segoe UI,Roboto,Arial,sans-serif;max-width:520px;margin:0 auto;padding:24px 20px;color:#1e2430;line-height:1.6;">
  ...
  <p style="font-size:17px;"><b>acabou a assinatura. Agora é pagamento único: R$&nbsp;97,90, seu pra sempre.</b></p>
