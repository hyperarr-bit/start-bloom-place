-- Admin funil: passo "Assinou" estava CEGO pro Pix (24/07). O paid_users só
-- contava trial_converted/subscription_started — eventos que o fluxo Pix
-- in-app não emite. Resultado: admin mostrando "Assinou 0" com 14 pagos reais
-- no dia. Passa a contar também pix_confirmed (cliente viu o pagamento cair)
-- e pix_reconciled (cron creditou pago-sem-acesso). DISTINCT por usuário,
-- então quem emite mais de um continua valendo 1.
-- Só o CTE paid_users muda; o resto é idêntico à 20260724050000.
