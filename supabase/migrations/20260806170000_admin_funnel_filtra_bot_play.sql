-- Admin funil: campanha da Play trouxe junto o crawler do Google (06/08).
-- Fingerprint: "Pixel 6 Pro" com Chrome/95 congelado — 27 sessões no 1º dia,
-- todas o mesmo roteiro (abre a welcome e morre em 3 eventos). Nenhum humano
-- tem esse par: Pixel 6 Pro real atualiza o WebView (150+). Sem filtro, o
-- bounce do topo parece 36% quando o real é ~20%.
-- Só entra o CTE bot_sessions + 1 condição no ev; o resto é idêntico à
-- 20260724170000.
