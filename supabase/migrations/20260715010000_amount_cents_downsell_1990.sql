-- 15/07: downsell sobe de 14,90 → 19,90. Preço chumbado em SQL quebraria o
-- histórico (vendas antigas eram 14,90). Fix definitivo: o webhook passa a
-- gravar o VALOR REALMENTE PAGO (data.amount da Cakto) em amount_cents; a
-- receita do admin usa COALESCE(valor real, mapa antigo por oferta).
