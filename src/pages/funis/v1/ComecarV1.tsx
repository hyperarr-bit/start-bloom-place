 ...
 * A demo é o app de verdade: o slide final manda pra /preview/financas?funnel=1&from=v1,
 * que tem um CTA "Quase lá" voltando pra cá em ?step=signup.
 */

type Step = "start" | "quiz" | "progress" | "result" | "central" | "signup" | "offer" | "confirm";

const DEMO_URL = "/preview/financas?funnel=1&from=v1";
...
const demoUrlFor = (area: AreaKey) =>
  `/preview/${AREAS[area].module}?funnel=1&tour=vida&from=v1${area === "metas" ? "&tab=metas" : ""}`;
...
export default function ComecarV1() {
