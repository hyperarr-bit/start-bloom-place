    ...
    <div className="min-h-screen bg-background">
      ...
      <SpotlightOverlay
        ...
        steps={[
          ...
          { selector: '[data-spotlight="tab-investimentos"]', label: 'Acompanhe seus investimentos aqui.', skippable: true, onEnter: () => setActiveTab("financeiro") },
          ...
          { selector: '[data-spotlight="tab-itens"]', label: 'Liste o que quer comprar e priorize.', skippable: true, onEnter: () => setActiveTab("investimentos") },
