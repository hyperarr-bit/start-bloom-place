    ...
    <div className="min-h-screen bg-background">
      ...
      <SpotlightOverlay
        ...
        steps={[
          ...
          { selector: '[data-spotlight="add-wish"]', label: 'Adicione um item que você quer comprar.', advanceOnAction: "first_wish", checkKey: "finance-wishlist", skippable: true, placement: "above", onEnter: () => setActiveTab("itens") },
