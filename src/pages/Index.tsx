    ...
    <div className="min-h-screen bg-background">
      ...
      <SpotlightOverlay
        ...
        steps={[
          ...
          { selector: '[data-spotlight="tab-limites"]', label: 'Toque em LIMITES embaixo e adicione um limite pra uma categoria.', checkKey: "finance-category-budgets", checkValue: (v: any) => v && typeof v === "object" && Object.keys(v).length > 0, onEnter: () => setActiveTab("itens") },
