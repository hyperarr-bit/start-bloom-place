    ...
    <div className="min-h-screen bg-background">
      ...
      <SpotlightOverlay
        ...
        steps={[
          ...
          { selector: '[data-spotlight="tab-investimentos"]', label: 'Acompanhe seus investimentos aqui.', skippable: true, onEnter: () => { setActiveTab("financeiro"); setTimeout(() => document.querySelector('[data-spotlight="tab-investimentos"]')?.scrollIntoView({ inline: "center", block: "nearest", behavior: "smooth" }), 150); } },
          { selector: '[data-spotlight="add-investment"]', label: 'Cadastre seu primeiro aporte.', advanceOnAction: "first_investment", checkKey: "finance-investments", skippable: true, onEnter: () => setActiveTab("investimentos") },
          { selector: '[data-spotlight="tab-itens"]', label: 'Liste o que quer comprar e priorize.', skippable: true, onEnter: () => { setActiveTab("investimentos"); setTimeout(() => document.querySelector('[data-spotlight="tab-itens"]')?.scrollIntoView({ inline: "center", block: "nearest", behavior: "smooth" }), 150); } },
          { selector: '[data-spotlight="add-wish"]', label: 'Adicione um item da sua lista de desejos.', advanceOnAction: "first_wish", checkKey: "finance-wishlist", skippable: true, onEnter: () => setActiveTab("itens") },
          { selector: '[data-spotlight="tab-limites"]', label: 'Toque em LIMITES embaixo.', skippable: true, onEnter: () => { setActiveTab("itens"); setTimeout(() => document.querySelector('[data-spotlight="tab-limites"]')?.scrollIntoView({ inline: "center", block: "nearest", behavior: "smooth" }), 150); } },
          { selector: '[data-spotlight="add-limit"]', label: 'Adicione um limite pra uma categoria.', advanceOnClick: false, checkKey: "finance-category-budgets", checkValue: (v: any) => v && typeof v === "object" && Object.keys(v).length > 0, skippable: true, onEnter: () => setActiveTab("limites") },
          { selector: '[data-spotlight="tab-relatorios"]', label: 'Veja relatórios mensais automáticos.', skippable: true, onEnter: () => { setActiveTab("limites"); setTimeout(() => document.querySelector('[data-spotlight="tab-relatorios"]')?.scrollIntoView({ inline: "center", block: "nearest", behavior: "smooth" }), 150); } },
          { selector: '[data-spotlight="tab-saude"]', label: 'Acompanhe sua saúde financeira em um índice.', skippable: true, onEnter: () => { setActiveTab("relatorios"); setTimeout(() => document.querySelector('[data-spotlight="tab-saude"]')?.scrollIntoView({ inline: "center", block: "nearest", behavior: "smooth" }), 150); } },
        ]}
      />
      {/* Header */}
